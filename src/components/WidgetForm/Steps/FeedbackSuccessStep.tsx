  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-8 w-[304px]">
        ...
        <span className="mt-2 text-xl" role="status">
        ...
        <button
          ...
          className="px-6 py-2 mt-5 text-sm leading-6 transition-colors border-transparent rounded bg-zinc-800 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:hover:bg-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
